...
const artifact_js_1 = __importDefault(require("../toolkit/packages/artifact/src/artifact.js"));
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const listArtifactResponse = yield artifact_js_1.default.listArtifacts({
            latest: true
        });
        ...
        const downloadPromises = artifacts.map(artifact => artifact_js_1.default.downloadArtifact(artifact.id, {
        ...
        if (inputs.deleteMerged) {
            const deletePromises = artifacts.map(artifact => artifact_js_1.default.deleteArtifact(artifact.name));
