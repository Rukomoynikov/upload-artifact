...
const artifact_js_1 = __importStar(require("../toolkit/packages/artifact/src/artifact.js"));
...
function deleteArtifactIfExists(artifactName) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield artifact_js_1.default.deleteArtifact(artifactName);
        }
        catch (error) {
            if (error instanceof artifact_js_1.ArtifactNotFoundError) {
